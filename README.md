...
- Turn-by-turn in-app menggunakan Google Maps Platform Navigation SDK (bukan lagi polyline custom).
...
3. Isi API key pada berkas `secrets.properties` (buat di root proyek) atau lewat environment variable saat build:
   ...
   Pastikan key sudah mengaktifkan layanan **Navigation SDK for Android** karena app sekarang memakai turn-by-turn bawaan SDK.

...
dependencies {
    ...
    // Maps SDK provided transitively by Navigation SDK; remove direct Maps Compose usage.
    ...
    implementation("com.google.android.libraries.navigation:navigation:7.2.0") {
        // Navigation SDK bundles Maps; keep the app's Maps dependency to avoid duplicates.
